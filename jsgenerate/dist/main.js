...
exports.tag = 'default db view init-trunc init-supplement';
exports.description = 'golang gin project template';
...
function jsgenerate(context) {
    getUUID(context).then((uuid) => {
        ...
        if (!md.view) {
            ...
            exclude.push('assets');
            let dir = path_1.join('web', 'static');
            prefix.push(dir + path_1.sep);
            exclude.push(dir);
            dir = path_1.join('web', 'view');
            prefix.push(dir + path_1.sep);
            exclude.push(dir);
